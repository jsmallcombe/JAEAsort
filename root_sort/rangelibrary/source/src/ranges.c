...
void def_absorber(int zt, int at, int iabso) {
  ...
  case 1: /* Mylar (C-10, H-8, O-4) */
    numel = 3;
    cmpnd[0].z = 6; cmpnd[0].a = 12; cmpnd[0].w = cmpnd[0].a*10.;
    cmpnd[1].z = 1; cmpnd[1].a = 1;  cmpnd[1].w = cmpnd[1].a*8.;
    cmpnd[2].z = 8; cmpnd[2].a = 16; cmpnd[2].w = cmpnd[2].a*4.;
    break;
  case 2: /* Polyethylene (C-2, H-4) */
    numel = 2;
    cmpnd[0].z = 6; cmpnd[0].a = 12; cmpnd[0].w = cmpnd[0].a*2.;
    cmpnd[1].z = 1; cmpnd[1].a = 1;  cmpnd[1].w = cmpnd[1].a*4.;
    break;
  case 3: /* Polypropylene (C-3, H-6) */
    numel = 2;
    cmpnd[0].z = 6; cmpnd[0].a = 12; cmpnd[0].w = cmpnd[0].a*3.;
    cmpnd[1].z = 1; cmpnd[1].a = 1;  cmpnd[1].w = cmpnd[1].a*6.;
    break;
  case 4: /* Kapton (H-10, C-22, N-2, O-5) */
    numel = 4;
    cmpnd[0].z = 1; cmpnd[0].a = 1;  cmpnd[0].w = cmpnd[0].a*10.;
    cmpnd[1].z = 6; cmpnd[1].a = 12; cmpnd[1].w = cmpnd[1].a*22.;
    cmpnd[2].z = 7; cmpnd[2].a = 14; cmpnd[2].w = cmpnd[2].a*2.;
    cmpnd[3].z = 8; cmpnd[3].a = 16; cmpnd[3].w = cmpnd[3].a*5.;
    break;
  case 5: /* Cesium Iodine (CsI) */
    numel = 2;
    cmpnd[0].z = 55; cmpnd[0].a = 133; cmpnd[0].w = cmpnd[0].a*1.;
    cmpnd[1].z = 53; cmpnd[1].a = 127; cmpnd[1].w = cmpnd[1].a*1.;
    break;
  case 6: /* Sodium Iodine (NaI) */
    numel = 2;
    cmpnd[0].z = 11; cmpnd[0].a = 23;  cmpnd[0].w = cmpnd[0].a*1.;
    cmpnd[1].z = 53; cmpnd[1].a = 127; cmpnd[1].w = cmpnd[1].a*1.;
    break;
  case 7: /* Aluminum Oxide (Al2O3) */
    numel = 2;
    cmpnd[0].z = 13; cmpnd[0].a = 27; cmpnd[0].w = cmpnd[0].a*2.;
    cmpnd[1].z = 8;  cmpnd[1].a = 16; cmpnd[1].w = cmpnd[1].a*3.;
    break;
  case 8: /* Tin-Lead (Sn60/Pb40) */
    numel = 4;
    cmpnd[0].z = 50; cmpnd[0].a = 116; cmpnd[0].w = 0.206*60.;
    cmpnd[1].z = 50; cmpnd[1].a = 118; cmpnd[1].w = 0.340*60.;
    cmpnd[2].z = 50; cmpnd[2].a = 120; cmpnd[2].w = 0.454*60.;
    cmpnd[3].z = 82; cmpnd[3].a = 208; cmpnd[3].w = 40.;
    break;
  ...
  case 100: /* Carbon Tetrafluoride (CF4) */
    numel = 2;
    cmpnd[0].z = 6; cmpnd[0].a = 12; cmpnd[0].w = cmpnd[0].a*1.;
    cmpnd[1].z = 9; cmpnd[1].a = 19; cmpnd[1].w = cmpnd[1].a*4.;
    break;
  case 101: /* Propane (H-8, C-3) */
    numel = 2;
    cmpnd[0].z = 1; cmpnd[0].a = 1;  cmpnd[0].w = cmpnd[0].a*8.;
    cmpnd[1].z = 6; cmpnd[1].a = 12; cmpnd[1].w = cmpnd[1].a*3.;
    break;
  case 102: /* Butane (H-10, C-4) */
    numel = 2;
    cmpnd[0].z = 1; cmpnd[0].a = 1;  cmpnd[0].w = cmpnd[0].a*10.;
    cmpnd[1].z = 6; cmpnd[1].a = 12; cmpnd[1].w = cmpnd[1].a*4.;
    break;
  case 103: /* Octane (H-18, C-8) */
    numel = 2;
    cmpnd[0].z = 1; cmpnd[0].a = 1;  cmpnd[0].w = cmpnd[0].a*18.;
    cmpnd[1].z = 6; cmpnd[1].a = 12; cmpnd[1].w = cmpnd[1].a*8.;
    break;
  default:
